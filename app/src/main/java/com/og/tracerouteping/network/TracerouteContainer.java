...
public class TracerouteContainer implements Serializable {
	...
	public TracerouteContainer(long timestamp, String hostname, String ip, float ms, boolean isSuccessful) {
	...
	public void toJson(JsonWriter writer) throws IOException {
		...
		writer.name("ms").value(ms);
		writer.name("isSuccessful").value(isSuccessful);
		writer.endObject();
	}
